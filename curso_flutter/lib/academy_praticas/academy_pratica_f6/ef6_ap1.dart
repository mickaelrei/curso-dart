...
String tipoSanguineoToString(TipoSanguineo tipo) {
  switch (tipo) {
...
// TipoSanguineo => Color
Color tipoSanguineoToColor(TipoSanguineo tipo) {
  const tipoSangueColor = <TipoSanguineo, Color>{
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: PersonPopupButton(
                      person: pessoa,
                      onRemove: () =>
                          // Não é necessário reconstruir nenhum Widget na
                          // tela pra remover uma pessoa da lista, então
                          // utilizar dessa maneira com listen: false
                          Provider.of<EstadoListaDePessoas>(context,
                                  listen: false)
                              .excluir(pessoa),
                    ),
                  );
